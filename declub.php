        ...
        <main>
            ...
            <section class="club-grid">
                <article class="info-blok">
                    <h2>Over ons</h2>
                    <p>SC Telstar is een Nederlandse profvoetbalclub uit IJmuiden, opgericht in 1963. De club speelt in het Boogerd Sport Stadion en staat bekend als de Witte Leeuwen.</p>
                </article>
                <article class="info-blok">
                    <h2>Contact</h2>
                    <ul>
                        <li><strong>Adres:</strong> Polderweg 1, IJmuiden</li>
                        <li><strong>E-mail:</strong> info@telstar.nl</li>
                        <li><strong>Telefoon:</strong> 0255 - 51 23 45</li>
                    </ul>
                </article>
                <article class="info-blok">
                    <h2>Stadion</h2>
                    <ul>
                        <li><strong>Naam:</strong> Boogerd Sport Stadion</li>
                        <li><strong>Capaciteit:</strong> 6.000 toeschouwers</li>
                        <li><strong>Geopend:</strong> 1993</li>
                    </ul>
                </article>
                <article class="info-blok">
                    <h2>Bereikbaarheid</h2>
                    <ul>
                        <li><strong>Auto:</strong> Afrit IJmuiden via de A9</li>
                        <li><strong>Bus:</strong> Lijn 74 richting IJmuiden Centrum</li>
                        <li><strong>Trein:</strong> Station Beverwijk, daarna bus 74</li>
                    </ul>
                </article>
            </section>
        </main>
